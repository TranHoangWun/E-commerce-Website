...
namespace SV22T1080069.Shop
{
    ...
    public class WebUserData
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ClaimsPrincipal CreatePrincipal()                        // Tạo đối tượng ClaimsPrincipal từ thông tin người dùng
        {
            // Tạo đối tượng ClaimsIdentity và ClaimsPrincipal từ danh sách các Claim để xác thực 
    ...
    {
        /// <summary>
        /// kiểm tra người dùng có thuộc role được chỉ định hay không, đọc thông tin từ ClaimsPrincipal
        /// </summary>
